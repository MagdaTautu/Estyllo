    ...
    <div id="rezervare">
      <div className="header">
        <div className="left">
          ...
          <p>
            Pasul <span>{currentIndex + 1}</span> din 2
          </p>
        </div>
      ...
      <div className="bottom">
        <div className="content">
          ...
          <div className={`page ${currentIndex === 1 ? "active" : ""}`} id="select_date">
            <p>Date disponibile</p>
            <DatePicker setNextPage={setNextPage} highlightedDates={highlightedDates} selectedPersonal={selectedPersonal}  selectedService={selectedService} setDate={setDate}  setHour={setHour}/>
...
export default Rezervare_generic;
